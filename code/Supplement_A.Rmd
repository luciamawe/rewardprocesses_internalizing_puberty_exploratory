...
```
## 2.9 Model: OFC activation (anticipation stage) ~ PDS
### Females
...
## 2.10 Model: OFC activation (feedback stage) ~ PDS
### Females
...
## 2.17 Model: OFC activation (anticipation stage) ~ Testosterone
### Females
```{r Exploratory1D_C, echo = FALSE}
...
## 2.18 Model: OFC activation (feedback stage) ~ Testosterone
### Females
```{r Exploratory1D_D, echo = FALSE}

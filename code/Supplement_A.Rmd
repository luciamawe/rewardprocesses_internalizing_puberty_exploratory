...
## 1.13 Model: CBCL internalizing factor ~ Testosterone + Pubertal stage 
### Females.
...
```
## 1.14 Model: CBCL Anxious-Depressed ~ Testosterone + Pubertal stage 
### Females.
```{r Exploratory2B, echo = FALSE}
#FEMALES
dataformodel <- data_no_test_outliers_females
...
summary(confirmatory2B_testosterone_CBCL_male_category$gam)
```
## 1.15 Model: CBCL Withdrawn-Depressed ~ Testosterone + Pubertal stage 
### Females.
```{r Exploratory2B, echo = FALSE}
#FEMALES
dataformodel <- data_no_test_outliers_females
...
summary(confirmatory2B_testosterone_CBCL_male_category$gam)
```
## 1.16 Model: CBCL Depressed DSM-5 ~ Testosterone + Pubertal stage 
### Females.
```{r Exploratory2B, echo = FALSE}
#FEMALES
dataformodel <- data_no_test_outliers_females
...
## 2.1 Model: BIS-BAS-RR ~ Pubertal stage
### Females.
...
## 2.2 Model : Reaction Time ~ Pubertal Stage
...
## 2.3 Model: Caudate Anticipation ~ Pubertal stage
### Females.
...
## 2.4 Model B: Putamen Anticipation ~ Pubertal stage
### Females.
...
## 2.5 Model: Accumbens Anticipation ~ Pubertal stage
### Females.
...
## 2.6 Model: Caudate Feedback  ~ Pubertal stage
### Females.
...
```
## 2.7 Model: Putamen Feedback ~ Pubertal stage
### Females.
...
```
## 2.8 Model: Accumbens Feedback ~ Pubertal stage
### Females.

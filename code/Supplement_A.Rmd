...
# RQ1-------------------------------
# Confirmatory Hypothesis 1: We hypothesize that advanced pubertal stage will be associated with higher internalizing symptoms as measured by the Child Behavior Checklist (CBCL) internalizing factor (Ullsperger & Nikolas, 2017).


## Model A: CBCL internalizing factor ~ PDS
### Females.
...
## Model B: CBCL Anxious-Depressed ~ PDS
### Females.
```{r Confirmatory2, echo = FALSE}
# Including CBCL outliers.
dataformodel <- PDS_correct_females
...
```
## Model C: CBCL Withdrawn-Depressed ~ PDS
### Females.
```{r Confirmatory2, echo = FALSE}
# Including CBCL outliers.
dataformodel <- PDS_correct_females
...
```
## Model D: CBCL Depressed DSM-5 ~ PDS
### Females.
```{r Confirmatory2, echo = FALSE}
# Including CBCL outliers.
dataformodel <- PDS_correct_females
...
# Exploratory Hypothesis 1: We hypothesize that advanced pubertal stage (categorical) will be associated with higher internalizing symptoms as measured by the Child Behavior Checklist (CBCL)?
...
# Exploratory Hypothesis 2: We will investigate whether testosterone relates to internalizing symptoms.
...
# Exploratory Hypothesis 3: We will investigate whether testosterone relates to internalizing symptoms after controlling for PDS.
...
# Exploratory Hypothesis 1A: We hypothesize that more advanced pubertal stages will be associated with greater self-reported reward responsiveness (BAS - RR) (Harden et al. 2018).
...
# Exploratory Hypothesis 1B: We hypothesize that greater pubertal stage will be associated with greater behavioral reactivity to reward (i.e., reaction time on reward vs. neutral trials).
...
# Confirmatory Hypothesis 2 SEPARATE STRIATAL REGIONS (anticipation stage) 
...
# Exploratory Hypothesis 1C: SEPARATE STRIATAL REGIONS (feedback stage)
...
# RQ3-------------------------------
# Confirmatory Hypothesis 3: We hypothesize that striatal regions and orbitofrontal cortex activity during the reward anticipation and feedback stages of the MID task will be negatively associated with internalizing symptoms (Forbes et al., 2010; Ubl et al., 2015; Luking et al., 2016).
...
## Model B: CBCL internalizing factor ~ Caudate activity (anticipation stage - All reward v. neutral)
### Females.
...
## Model C: CBCL internalizing factor ~ Putamen activity (anticipation stage - All reward v. neutral)
### Females.
...
## Model D: CBCL internalizing factor ~ Accumbens activity (feedback stage)
### Females.
...
## Model E: CBCL internalizing factor ~ Caudate activity (feedback stage)
### Females.
...
## Model F: CBCL internalizing factor ~ Putamen activity (feedback stage)
### Females.
...
## Model G: CBCL internalizing factor ~ Orbitofrontal cortex activity (anticipation stage)
### Females.
...
## Model H: CBCL internalizing factor ~ Orbitofrontal cortex activity (feedback stage)
### Females.
...
##Model A: CBCL internalizing factor ~ PDS*accumbens activity (anticipation stage)
### Females
...
##Model B: CBCL internalizing factor ~ PDS*caudate activity (anticipation stage)
### Females
...
##Model C: CBCL internalizing factor ~ PDS*putamen activity (anticipation stage)
### Females
...
##  Model A: CBCL internalizing factor ~ PDS*accumbens activity 
###Females
...
##  Model B: CBCL internalizing factor ~ PDS*caudate activity 
###Females
...
##  Model C: CBCL internalizing factor ~ PDS*putamen activity 
###Females
...
##Model A: CBCL internalizing factor ~ PDS*accumbens activity (anticipation stage) + testosterone
### Females
...
##Model B: CBCL internalizing factor ~ PDS*caudate activity (anticipation stage) + testosterone
### Females
...
##Model C: CBCL internalizing factor ~ PDS*putamen activity (anticipation stage) + testosterone
### Females

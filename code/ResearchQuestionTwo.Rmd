...
dataformodel$PDS_score_squared <- (dataformodel$PDS_score)^2
confirmatory2_quadratic <- gamm4(cbcl_scr_syn_internal_r ~ PDS_score + PDS_score_squared +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      data = dataformodel, 
                      random = ~ (1 | site_id_l/rel_family_id))
summary(confirmatory2_quadratic$gam)

confirmatory2_quadratic <- lmer(cbcl_scr_syn_internal_r ~ PDS_score + PDS_score_squared +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      data = dataformodel)
summary(confirmatory2_quadratic)
...
#TESTING PDS CATEGORY
dataformodel <- subset(PDS_correct_females, cbcl_scr_syn_internal_r_z > -3 & cbcl_scr_syn_internal_r_z < 3)
...
dataformodel <- subset(PDS_correct_females, cbcl_scr_syn_internal_r_z > -3 & cbcl_scr_syn_internal_r_z < 3 & pds_p_ss_category !="5")

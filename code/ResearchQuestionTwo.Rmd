...
length(data_no_CBCL_striatal_ant_outliers$src_subject_id) # 
...
length(data_no_CBCL_striatal_ant_outliers_females$src_subject_id) # 
...
length(data_no_CBCL_striatal_ant_outliers_males$src_subject_id) # 
```

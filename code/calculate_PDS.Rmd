...
PDS = read.table( "C:\\Users\\Lucia\\Dropbox\\ABCD study\\ABCD shared LNKW\\data\\abcd_ppdms01.txt","\t",na.strings=c("", 999,"NA"),header=T)  #pad empty cells with NAs
PDS=as_tibble(PDS)
PDS$interview_age=as.numeric(levels(PDS$interview_age))[PDS$interview_age]
head(PDS$interview_age)
```

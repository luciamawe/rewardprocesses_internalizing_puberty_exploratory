...
# For the exploratory dataset, this is the number of participants in each of the seven categories.
# AIAN Asian Black Mixed  NHPI Other White 
#   22   102   666   542     6   198  2964
# So we are going to use the five levels for race ("White", "Black", "Asian", "Other", "Mixed") and also use the variable demo_race_hispanic.

# This is the same as define_dataframes except that the models now do not exclude testosterone outliers.
...
data_no_striatal_ant_test_outliers <- data_no_striatal_ant_outliers
...
data_no_striatal_ant_test_outliers_females <- data_no_striatal_ant_outliers_females
...
data_no_striatal_ant_test_outliers_males <- data_no_striatal_ant_outliers_males
...
data_no_striatal_feed_test_outliers <- data_no_striatal_feed_outliers
...
data_no_striatal_feed_test_outliers_females <- data_no_striatal_feed_outliers_females
...
data_no_striatal_feed_test_outliers_males <- data_no_striatal_feed_outliers_males
...
data_no_lOFC_ant_test_outliers <- data_no_lOFC_ant_outliers
...
data_no_lOFC_ant_test_outliers_females <- data_no_lOFC_ant_outliers_females
...
data_no_lOFC_ant_test_outliers_males <- data_no_lOFC_ant_outliers_males
...
data_no_lOFC_feed_test_outliers <- data_no_lOFC_feed_outliers
...
data_no_lOFC_feed_test_outliers_females <- data_no_lOFC_feed_outliers_females
...
data_no_lOFC_feed_test_outliers_males <- data_no_lOFC_feed_outliers_males
...
data_no_mOFC_ant_test_outliers <- data_no_mOFC_ant_outliers
...
data_no_mOFC_ant_test_outliers_females <- data_no_mOFC_ant_outliers_females
...
data_no_mOFC_ant_test_outliers_males <- data_no_mOFC_ant_outliers_males
...
data_no_mOFC_feed_test_outliers <- data_no_mOFC_feed_outliers
...
data_no_mOFC_feed_test_outliers_females <- data_no_mOFC_feed_outliers_females
...
data_no_mOFC_feed_test_outliers_males <- data_no_mOFC_feed_outliers_males
...
data_no_bisbas_test_outliers <- data_no_bisbas_outliers
...
data_no_bisbas_test_outliers_females <- data_no_bisbas_outliers_females
...
data_no_bisbas_test_outliers_males <- data_no_bisbas_outliers_males
...
data_no_RT_test_outliers_females <- data_no_RT_MID_outliers_females
#data_no_RT_test_outliers_males <- subset(data_no_RT_MID_outliers_males, hormone_scr_ert_mean_z > -3 & hormone_scr_ert_mean_z < 3)
data_no_RT_test_outliers_males <- data_no_RT_MID_outliers_males
...
data_no_accumbens_ant_no_test_outliers_females <- subset(MID_imaging_correct_females, accumbens_rvsn_ant_z > -3 & accumbens_rvsn_ant_z < 3)
...
data_no_accumbens_ant_no_test_outliers_males <- subset(MID_imaging_correct_males, accumbens_rvsn_ant_z > -3 & accumbens_rvsn_ant_z < 3)
...
data_no_caudate_ant_no_test_outliers_females <- subset(MID_imaging_correct_females, caudate_rvsn_ant_z > -3 & caudate_rvsn_ant_z < 3)
...
data_no_caudate_ant_no_test_outliers_males <- subset(MID_imaging_correct_males, caudate_rvsn_ant_z > -3 & caudate_rvsn_ant_z < 3)
...
data_no_putamen_ant_no_test_outliers_females <- subset(MID_imaging_correct_females, putamen_rvsn_ant_z > -3 & putamen_rvsn_ant_z < 3)
...
data_no_putamen_ant_no_test_outliers_males <- subset(MID_imaging_correct_males, putamen_rvsn_ant_z > -3 & putamen_rvsn_ant_z < 3)
...
data_no_accumbens_feed_no_test_outliers <- subset(MID_imaging_correct, accumbens_posvsneg_feedback_z > -3 & accumbens_posvsneg_feedback_z < 3) 
...
data_no_accumbens_feed_no_test_outliers_females <- subset(MID_imaging_correct_females, accumbens_posvsneg_feedback_z > -3 & accumbens_posvsneg_feedback_z < 3)
...
data_no_accumbens_feed_no_test_outliers_males <- subset(MID_imaging_correct_males, accumbens_posvsneg_feedback_z > -3 & accumbens_posvsneg_feedback_z < 3)
...
data_no_caudate_feed_no_test_outliers <- subset(MID_imaging_correct, caudate_posvsneg_feedback_z > -3 & caudate_posvsneg_feedback_z < 3) 
...
data_no_caudate_feed_no_test_outliers_females <- subset(MID_imaging_correct_females, caudate_posvsneg_feedback_z > -3 & caudate_posvsneg_feedback_z < 3)
...
data_no_caudate_feed_no_test_outliers_males <- subset(MID_imaging_correct_males, caudate_posvsneg_feedback_z > -3 & caudate_posvsneg_feedback_z < 3)
...
data_no_putamen_feed_no_test_outliers <- subset(MID_imaging_correct, putamen_posvsneg_feedback_z > -3 & putamen_posvsneg_feedback_z) 
...
data_no_putamen_feed_no_test_outliers_females <- subset(MID_imaging_correct_females, putamen_posvsneg_feedback_z > -3 & putamen_posvsneg_feedback_z < 3)
...
data_no_putamen_feed_outliers_no_test_males <- subset(MID_imaging_correct_males, putamen_posvsneg_feedback_z > -3 & putamen_posvsneg_feedback_z < 3)

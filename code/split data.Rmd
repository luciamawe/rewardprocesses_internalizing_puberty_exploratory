...
#SAVE DATA
```{r}
saveRDS(ABCD_Data_exploratory, paste(output_directory,"nda20_exploratory.rds",sep="/"))
write.csv(nda20, paste(output_directory,"nda20_exploratory.csv",sep="/"), row.names = FALSE)
```

```{r}
saveRDS(ABCD_Data_confirmatory, paste(output_directory,"nda20_confirmatory.rds",sep="/"))
write.csv(nda20, paste(output_directory,"nda20_confirmatory.csv",sep="/"), row.names = FALSE)
```
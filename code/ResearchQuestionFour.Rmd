...
#Explore outliers
boxplot(data$accumbens_rvsn_ant)
boxplot(data$caudate_rvsn_ant)
boxplot(data$putamen_rvsn_ant)
...
confirmatory4_compositestriatum <- lm(cbcl_scr_syn_internal_r ~ PDS_score*striatum_rvsn_ant + 
                            race.eth.7level +
                            demo_race_hispanic +
                            high.educ +
                            household.income +
...
plot_model(confirmatory4_compositestriatum,type = "int", show.data = FALSE) 

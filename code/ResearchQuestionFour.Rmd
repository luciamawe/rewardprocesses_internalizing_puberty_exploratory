...
<<<<<<< HEAD
# Separate analyses first. Exclude outliers.
confirmatory4_accumbens <- lm(cbcl_scr_syn_internal_t ~ PDS_score*accumbens_rvsn_ant_z + 
=======
```{r Confirmatory4, echo = FALSE}
# Separate analyses first.
confirmatory4_accumbens <- lm(cbcl_scr_syn_internal_t ~ PDS_score*accumbens_rvsn_ant + 
>>>>>>> 94068d7f6454c1ed17c87cfab2f1a8ba911493c1
                            race.eth.7level +
                            demo_race_hispanic +
                            high.educ +
                            household.income +
...
<<<<<<< HEAD
confirmatory4_compositestriatum <- lm(cbcl_scr_syn_internal_t ~ PDS_score*striatum_rvsn_ant_z + 
=======

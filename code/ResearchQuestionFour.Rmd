...
data$race.eth.5level <- as.factor(data$race.eth.5level)
...
data$race.ethnicity.5level = data$race.eth.5level
data$race.ethnicity.5level[(data$race.eth.5level == "AIAN" | data$race.eth.5level == "NHPI")] = "Other"
...
tempdata <- data[which(complete.cases(data[,c("race.ethnicity.5level",
                            "demo_race_hispanic",
                            "high.educ",
                            "household.income",
                            "married.or.livingtogether",

...
cor.test(data$accumbens_rvsn_ant_z,data$caudate_rvsn_ant_z) # Exp 0.64.
cor.test(data$accumbens_rvsn_ant_z,data$putamen_rvsn_ant_z) # Exp 0.63.
cor.test(data$caudate_rvsn_ant_z,data$putamen_rvsn_ant_z) # Exp 0.851. 

...
confirmatory4_compositestriatum <- lm(cbcl_scr_syn_internal_r ~ PDS_score*striatum_rvsn_ant_z +
                            race.eth.7level +
                            demo_race_hispanic +
                            high.educ +
                            household.income +
...
p <- plot_model(confirmatory4_compositestriatum,type = "int", terms = "PDS_score", 
   ...
   theme(title= element_text(size=20, vjust=2, face="bold"),
         ...
         legend.title=element_text(size=12, colour = "black",title="Striatal activity \n (reward anticipation vs neutral z-score")),
        # legend.position="none",
         strip.text = element_text(size=18, face="bold"),
         panel.background = element_blank(),
         axis.line = element_line(colour = "black"))
p + labs(fill = "Striatal activity \n (reward anticipation vs neutral z-score")")

+ guides(fill=guide_legend(title="Striatal activity \n (reward anticipation vs neutral z-score"))

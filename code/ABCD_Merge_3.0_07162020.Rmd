...
# sph01 <- read.csv(paste(data_directory,"sph01.csv",sep="/"))
```
...
pdem02 = pdem02[,!(names(pdem02) %in% c("collection_id", "collection_title", "subjectkey", "sex", "interview_age"))]

sph01 = sph01[,!(names(sph01) %in% c("collection_id", "collection_title", "subjectkey", "sex", "interview_age", "interview_date"))]
...
# For whatever reason, "eventname" column is called "visit" in the sph01 text file so will change that here.
sph01 <- rename(sph01, c("visit"="eventname"))


t2 = list(bisbas01, cbcls01, hsss01, lpds01, lt01, mid02, ppdms01, ypdms01, fhxp102, midaparc03, midaparcp203, pdem02, sph01)
...
# This is from the original merge script but seems to be causing issues.

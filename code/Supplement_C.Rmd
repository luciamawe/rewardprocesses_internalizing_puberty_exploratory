...
confirmatory1_caudate_females <- gamm4(caudate_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
confirmatory1_caudate_males<- gamm4(caudate_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
confirmatory1_putamen_females <- gamm4(putamen_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
confirmatory1_putamen_males <- gamm4(putamen_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
confirmatory1_accumbens_females <- gamm4(accumbens_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
confirmatory1_accumbens_males <- gamm4(accumbens_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
exploratory1A_caudate_females <- gamm4(caudate_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
exploratory1A_caudate_males <- gamm4(caudate_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
exploratory1A_putamen_females <- gamm4(putamen_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
exploratory1A_putamen_males <- gamm4(putamen_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
exploratory1A_accumbens_females <- gamm4(accumbens_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
exploratory1A_accumbens_males <- gamm4(accumbens_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelC_females_lOFC <- gamm4(lOFC_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelC_females_mOFC <- gamm4(mOFC_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelC_males_lOFC <- gamm4(lOFC_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelC_males_mOFC <- gamm4(mOFC_rvsn_ant_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelD_females_lOFC <- gamm4(lOFC_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelD_females_mOFC <- gamm4(mOFC_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelD_males_lOFC <- gamm4(lOFC_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelD_males_mOFC <- gamm4(mOFC_posvsneg_feedback_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelE_lg_neutral_RT_females <- gamm4(rt_diff_large_neutral_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
dataformodel <- data_no_RT_test_outliers_females # No MID RT difference score or testosterone outliers.
modelE_lg_small_RT_females <- gamm4(rt_diff_large_small_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelE_lg_neutral_RT_males <- gamm4(rt_diff_large_neutral_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelE_lg_small_RT_males <- gamm4(rt_diff_large_small_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelF_females <- gamm4(bisbas_ss_basm_rr_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)
...
modelF_males <- gamm4(bisbas_ss_basm_rr_z ~ hormone_scr_ert_mean_z + interview_age + bmi,
                               random = ~ (1 | site_id_l/rel_family_id),
                               data = dataformodel)

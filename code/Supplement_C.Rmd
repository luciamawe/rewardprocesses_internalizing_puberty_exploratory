...
```{r}
#library(Hmisc)
cor_female<- MID_task_correct %>% 
  dplyr::select("src_subject_id",
                "rt_diff_large_neutral_z",
                "rt_diff_large_small_z")

cor_female_1 <- PDS_correct_females %>% 
  dplyr::select("src_subject_id",
                "cbcl_scr_syn_internal_r",
                    ...
                    "MRI_minus_hormone_date_time",
                    "hormone_date_minus_last_period_date",
                    )

cor_female_2 <- left_join(cor_female_1, cor_female, by="src_subject_id")
...
corMat_f <- flattenCorrMatrix(cor_female_2$r, cor_female_2$P)
corMat_f

format(corMat_f, scientific = F, digits = 3)
```
## Males
```{r}

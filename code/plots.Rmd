...
predict.gam(pds_stage_cbcl_females_sample1$gam)
predict_merMod(pds_stage_cbcl_females_sample1$mer) # Why are these predicted values negative? Maybe because many of the values are around zero?

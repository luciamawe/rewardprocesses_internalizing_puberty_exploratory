...
exploratory1C_lrgRT_females <- gamm4(rt_diff_large_neutral_z ~ PDS_score +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(exploratory1C_lrgRT_females$gam)

#SMALL REWARD VS. NEUTRAL POSITIVE
exploratory1C_smRT_females <- gamm4(rt_diff_small_neutral_z ~ PDS_score +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(exploratory1C_smRT_females$gam)
```
...
#LARGE REWARD VS. NEUTRAL POSITIVE
exploratory1C_lrgRT_males <- gamm4(rt_diff_large_neutral_z ~ PDS_score +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(exploratory1C_lrgRT_males$gam)

#SMALL REWARD VS. NEUTRAL POSITIVE
exploratory1C_smRT_males <- gamm4(rt_diff_small_neutral_z ~ PDS_score +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(exploratory1C_smRT_males$gam)
```
...
modelE_lrgRT_females <- gamm4(rt_diff_large_neutral_z ~ hormone_scr_ert_mean_z +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(modelE_lrgRT_females$gam)

# Females - SMALL REWARD VS. NEUTRAL
dataformodel <- data_no_RT_test_outliers_females # No MID RT difference score or testosterone outliers.
modelE_smRT_females <- gamm4(rt_diff_small_neutral_z ~ hormone_scr_ert_mean_z +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(modelE_smRT_females$gam)
...
modelE_lrgRT_males <- gamm4(rt_diff_large_neutral_z ~ hormone_scr_ert_mean_z +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +
                      ...
                      random = ~ (1 | site_id_l/rel_family_id),
                      data = dataformodel)
summary(modelE_lrgRT_males$gam)


modelE_smRT_males <- gamm4(rt_diff_small_neutral_z ~ hormone_scr_ert_mean_z +
                      race.ethnicity.5level +
                      high.educ +
                      household.income +
                      married.or.livingtogether +

...
flattenCorrMatrix <- function(cormat, pmat,nmat) {
  ut <- upper.tri(cormat)
  data.frame(
    variable1 = rownames(cormat)[col(cormat)[ut]],
    variable2 = rownames(cormat)[row(cormat)[ut]],
    number_complete_observations = nmat[ut],
...
#cormat_females_flat
print(format(cormat_females_flat, scientific = F, digits = 3))
```
## Males
```{r,echo = FALSE}

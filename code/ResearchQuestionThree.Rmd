...
## Model A: CBCL internalizing factor ~ Striatal activity (anticipation stage)
#### Females.
...
## Model A: CBCL internalizing factor ~ Striatal activity (anticipation stage - LARGE REWARD V. NEUTRAL)
#### Females.
```{r Confirmatory3AFemale, echo = FALSE}
dataformodel <- data_no_CBCL_striatal_ant_outliers_females
...
## Model B: CBCL internalizing factor ~ Striatal activity (feedback stage)
#### Females.
...
# Medial OFC.
dataformodel <- data_no_CBCL_mOFC_ant_outliers_females
...
# Medial OFC.
dataformodel <- data_no_CBCL_mOFC_ant_outliers_males
...
# Medial OFC.
dataformodel <- data_no_CBCL_mOFC_feed_outliers_females
...
# Medial OFC.
dataformodel <- data_no_CBCL_mOFC_feed_outliers_males
...
dataformodel <- data_no_CBCL_bisbas_outliers_females
...
dataformodel <- data_no_CBCL_bisbas_outliers_males
